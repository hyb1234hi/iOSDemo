...
- (MXPullDownMenu *)initWithFream:(CGRect)frame array:(NSArray *)array selectedColor:(UIColor *)color {
    ...
    if (self) {
        ...
        _menuColor = [UIColor colorWithRed:149/255.0 green:149/255.0 blue:149/255.0 alpha:1.0];
...
//
//        }
        CGSize  textSize = [self calculateTitleSizeWithString:array[0][0]];
        CGPoint position = CGPointMake(45 , self.frame.size.height / 2);
        CATextLayer *title = [self creatTextLayerWithNSString:_array[0][0] withColor:_menuColor andPosition:position];
        [self.layer addSublayer:title];
        [_titles addObject:title];
        
        CAShapeLayer *indicator = [self creatIndicatorWithColor:_menuColor andPosition:CGPointMake(kWindowWidth-25 , self.frame.size.height / 2)];
        [self.layer addSublayer:indicator];
        [_indicators addObject:indicator];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.textLabel setTextColor:[UIColor colorWithRed:149/255.0 green:149/255.0 blue:149/255.0 alpha:1.0]];
...
- (void)confiMenuWithSelectRow:(NSInteger)row
{
    ...
    indicator.position = CGPointMake(kWindowWidth-25, indicator.position.y);
}
